...
set RTLIBCFG=static
nmake /f Makefile.vc mode=static WITH_SSL=static WITH_DEVEL=C:\usr VC=%VCVERSION% ENABLE_SSPI=no ENABLE_IDN=no ENABLE_WINSSL=no DEBUG=no GEN_PDB=no ENABLE_IPV6=yes
